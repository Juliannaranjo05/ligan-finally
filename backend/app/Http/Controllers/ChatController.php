        ...
        try {
            ...
            foreach ($sessions as $session) {
                ...
                $conversations[] = [
                    ...
                    'last_message_type' => $lastMessage ? ($lastMessage->type ?? 'text') : 'text',
                    'last_message_extra_data' => $lastMessage ? ($lastMessage->extra_data ?? null) : null,
                    ...
                    'last_message_sender_name' => $lastMessage ? $lastMessage->user_name : null,
                    'last_message_sender_role' => $lastMessage ? $lastMessage->user_role : null,
